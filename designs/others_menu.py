...
"color:rgb(255, 255, 255);")
        ...
        self.horizontalSlider.setMinimumSize(QtCore.QSize(460, 60))
        self.horizontalSlider.setMaximumSize(QtCore.QSize(460, 60))
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", " Негатив"))
